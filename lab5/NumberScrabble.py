class NumberScrabble:
    ...
    def minimax(self, depth, isMax):
        ...
        if isMax:
            ...
            for move in self.available_moves.copy():
                ...
                current_score = self.minimax(depth + 1, not isMax)
            ...
            for move in self.available_moves.copy():
                ...
                best_score = min(best_score, self.minimax(depth + 1, isMax))
                self.matrix[result[0]][result[1]] = move
                self.available_moves.add(move)
            return best_score
    ...
    def play(self):
        while not self.is_final():
            ...
            # Player A's turn
            try:
                player1_move = int(input("Player A's turn. Enter a number between 1 and 9: "))
